...
public class Account000 {
    ...
    public Account000(int id, String iban, String firstname, String lastname, String ssn, double balance) {
        this.id = id;
        this.iban = iban;
    ...
    /**
     * Withrdays an amount of money based on
     * a valid ssn.
     *
     * @param amount        the amount to be withdrawn
     * @param ssn           the given ssn
     * @throws Exception    if the ssn is not valid or the balance
     *                      is not sufficient
     */
