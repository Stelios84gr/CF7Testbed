...
public class Main {
    ...
    public static void main(String[] args) {
        Teacher teacher = new Teacher(1, "Stelios", "Fridakis");
        User user = new User(1, "Kostas", "Mask", "cmask", "12345", true);
        Customer customer = new Customer(1, "Andrew", "Dimitriou", "076543289", "6937687654", "Attica", "West Attica" ,"Athens", "Patission", "76", "10434");
        Point point = new Point(0, 10);
        Order order = new Order(1, 5.5, "Meat", "Delivered");
