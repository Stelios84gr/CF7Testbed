...
/**
 * Κωδικοποιεί τον 1ο χαρακτήρα του μηνύματος με την ακέραια τιμή που αντιστοιχεί σε αυτόν
 * (από τον κώδικα ASCII). Κωδικοποιεί τους επόμενους χαρακτήρες: (α) προσθέτοντας την ακέραια
 ...
 */
public class Cryptography000 {

    public static void main(String[] args) {
        // Το κλειδί πρέπει να είναι αρκετά μεγάλο ώστε να αποκρυπτογραφεί από 0 έως 127
        final int KEY = 128;
